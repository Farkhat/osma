const ru = {
    ...
    "about-us-description": "Образована в 2008 году. Мы имеем многолетний опыт в строительно- монтажных работах различной сложности. За этот период работы мы выполнили различные  виды строительных работ соответствующих лицензии, включая строительство 9-ти этажных жилых домов, отделочные, кровельные, электромонтажные работы на объектах строительства жилья , в городах Ош, Каракол, Нарын.",
    ...
    // footer
    "footer-fast-links": "Быстрые ссылки",
    ...
    // News
    "news-title":"Новости",
    "news-1": "Коттеджный городок в с. Люксембург Ысык-Атинского района", 
    "news-2": "Тепловые сети систем централизованного теплоснабжения", 
    "news-3": "Новости архитектуры и дизайна в мире", 
    "news-more": "Подробнее", 

    // NewsInfo
    "news-date": "2021 / 02 / 28",
    "news-description": "Мы начали строительство коттеджного городка в с.Люксембург Ысык-Атинсокго района. Работа запланирована на 12 месяцев. Заказчиками выступают частные инвесторы. По проекту на территории будут построены 39 коттедже с  благоустройством.",
    ...
    "career-file-upload-warning": "Обратите внимание на то, чтобы Ваш файл не превышал лимит в 50 Kb, наиболее лучше всего подойдут форматы Word или сжатый PDF",
    "career-not-selected": "Файл не выбран",
    "career-send": "Отправить",
    "career-sent-successful": "Ваше сообщение успешно отправлено!",
    "career-sent-failed": "Ошибка! Попробуйте еще раз!",
